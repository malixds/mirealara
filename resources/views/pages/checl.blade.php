...
<head>
    ...
    <script data-n-head="ssr" src="https://unpkg.com/alpinejs@3.10.2/dist/cdn.min.js" defer></script>
    <link rel="preload" href="/_nuxt/935c6dc.js" as="script">
    <link rel="preload" href="/_nuxt/4827497.js" as="script">
    <link rel="preload" href="/_nuxt/546c9d8.js" as="script">
    <link rel="preload" href="/_nuxt/f824e29.js" as="script">
    <link rel="preload" href="/_nuxt/459230f.js" as="script">
    <link rel="preload" href="/_nuxt/f1383dd.js" as="script">
    <style data-vue-ssr-id="65b97e00:0 17bc9ac2:0 17bc9ac2:1 46f23c9d:0">
        ...
        *,
        ...
        .-rotate-\[3\.5deg\] {
            --tw-rotate: -3.5deg;
            transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(-3.5deg) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
            transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
        }

        .-rotate-\[4\.5deg\] {
            --tw-rotate: -4.5deg;
            transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(-4.5deg) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
            transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
        }
        ...
        .border-\[\#1353fe\] {
            --tw-border-opacity: 1;
            border-color: #1353fe;
            border-color: rgba(19, 83, 254, var(--tw-border-opacity))
        }

        .border-\[\#4273f6\] {
            --tw-border-opacity: 1;
            border-color: #4273f6;
            border-color: rgba(66, 115, 246, var(--tw-border-opacity))
        }

        .border-\[\#5481fb\] {
            --tw-border-opacity: 1;
            border-color: #5481fb;
            border-color: rgba(84, 129, 251, var(--tw-border-opacity))
        }

        .border-\[\#636262\] {
            --tw-border-opacity: 1;
            border-color: #636262;
            border-color: rgba(99, 98, 98, var(--tw-border-opacity))
        }
        ...
        .border-\[\#c0d1ff\] {
            --tw-border-opacity: 1;
            border-color: #c0d1ff;
            border-color: rgba(192, 209, 255, var(--tw-border-opacity))
        }

        .border-\[\#ffffff1f\] {
            border-color: hsla(0, 0%, 100%, .122)
        }
        ...
        .bg-\[\#020d24\] {
            ...
            background-color: rgba(2, 13, 36, var(--tw-bg-opacity))
        }

        .bg-\[\#081631\] {
            --tw-bg-opacity: 1;
            background-color: #081631;
            background-color: rgba(8, 22, 49, var(--tw-bg-opacity))
        }

        .bg-\[\#1353FE\] {
            --tw-bg-opacity: 1;
            background-color: #1353fe;
            background-color: rgba(19, 83, 254, var(--tw-bg-opacity))
        }

        .bg-\[\#1353fe33\] {
            background-color: rgba(19, 83, 254, .2)
        }
        ...
        .bg-\[\#2d6ae0\] {
            ...
            background-color: rgba(45, 106, 224, var(--tw-bg-opacity))
        }

        .bg-\[\#376dfd\] {
            --tw-bg-opacity: 1;
            background-color: #376dfd;
            background-color: rgba(55, 109, 253, var(--tw-bg-opacity))
        }

        .bg-\[\#4273f6\] {
            --tw-bg-opacity: 1;
            background-color: #4273f6;
            background-color: rgba(66, 115, 246, var(--tw-bg-opacity))
        }

        .bg-\[\#5481FB\] {
            --tw-bg-opacity: 1;
            background-color: #5481fb;
            background-color: rgba(84, 129, 251, var(--tw-bg-opacity))
        }
        ...
        .bg-\[\#c0d1ff\] {
            ...
            background-color: rgba(192, 209, 255, var(--tw-bg-opacity))
        }

        .bg-\[\#ecf2ff\] {
            --tw-bg-opacity: 1;
            background-color: #ecf2ff;
            background-color: rgba(236, 242, 255, var(--tw-bg-opacity))
        }
        ...
        .bg-\[url\(\'https\:\/\/assets\.website-files\.com\/63904f663019b0d8edf8d57c\/6390526ac2a607693620c97b_Rectangle\%2010\.svg\'\)\] {
            background-image: url(https://assets.website-files.com/63904f663019b0d8edf8d57c/6390526ac2a607693620c97b_Rectangle%2010.svg)
        }

        .bg-\[url\(\'https\:\/\/assets\.website-files\.com\/63904f663019b0d8edf8d57c\/639156ce1c70c97aeb755c8a_Rectangle\%2010\%20\(1\)\.svg\'\)\] {
        ...
        .bg-\[url\(\'https\:\/\/assets\.website-files\.com\/63904f663019b0d8edf8d57c\/63915f9749aaab0572c48dae_Rectangle\%2018\.svg\'\)\] {
            background-image: url(https://assets.website-files.com/63904f663019b0d8edf8d57c/63915f9749aaab0572c48dae_Rectangle%2018.svg)
        }

        .bg-\[url\(\'https\:\/\/assets\.website-files\.com\/63904f663019b0d8edf8d57c\/6391714b7ac2b51acc1a2548_Rectangle\%2017\%20\(1\)\.svg\'\)\] {
        ...
        .bg-\[url\(\'https\:\/\/assets\.website-files\.com\/63904f663019b0d8edf8d57c\/6391a5b04f2836ad87dcc3bc_Rectangle\%20773\.svg\'\)\] {
        ...
        .bg-\[url\(\'https\:\/\/assets\.website-files\.com\/63904f663019b0d8edf8d57c\/6391a6daa19785eb51dd3666_CTA\%20\(2\)\.svg\'\)\] {
            background-image: url("https://assets.website-files.com/63904f663019b0d8edf8d57c/6391a6daa19785eb51dd3666_CTA%20(2).svg")
        }

        .bg-\[url\(\'https\:\/\/assets\.website-files\.com\/63904f663019b0d8edf8d57c\/6399731b4cdf484f42d3d80b_Mask\%20group\%20\(2\)\.svg\'\)\] {
        ...
        .bg-\[url\(\'https\:\/\/firebasestorage\.googleapis\.com\/v0\/b\/flowspark-1f3e0\.appspot\.com\/o\/6391a6daa19785eb51dd3666_CTA\%20\(2\)\%20\(1\)\.svg\?alt\=media\&token\=b877deae-f9fb-4f75-ad69-cbc62e593e50\'\)\] {
        ...
        .text-\[\#1353fe\] {
            --tw-text-opacity: 1;
            color: #1353fe;
            color: rgba(19, 83, 254, var(--tw-text-opacity))
        }
        ...
        .text-\[\#636262\] {
            --tw-text-opacity: 1;
            color: #636262;
            color: rgba(99, 98, 98, var(--tw-text-opacity))
        }

        .text-\[\#647084\] {
            --tw-text-opacity: 1;
            color: #647084;
            color: rgba(100, 112, 132, var(--tw-text-opacity))
        }

        .text-\[\#7c8aaa\] {
            --tw-text-opacity: 1;
            color: #7c8aaa;
            color: rgba(124, 138, 170, var(--tw-text-opacity))
        }
        ...
        .\[box-shadow\:rgb\(0\2c 0\2c 0\)_6px_6px\] {
            box-shadow: 6px 6px #000
        }

        .\[box-shadow\:rgb\(0\2c _0\2c _0\)_-4px_4px\] {
            box-shadow: -4px 4px #000
        }

        .\[box-shadow\:rgb\(0\2c _0\2c _0\)_0px_3px\] {
        ...
        .\[box-shadow\:rgb\(0\2c _0\2c _0\)_0px_6px\] {
            box-shadow: 0 6px #000
        }

        .\[box-shadow\:rgb\(0\2c _0\2c _0\)_2px_2px\] {
            box-shadow: 2px 2px #000
        }

        .\[box-shadow\:rgb\(0\2c _0\2c _0\)_4px_4px\] {
            box-shadow: 4px 4px #000
        }

        .\[box-shadow\:rgb\(0\2c _0\2c _0\)_6px_6px\] {
            box-shadow: 6px 6px #000
        }
        ...
        .\[box-shadow\:rgb\(106\2c _218\2c _255\)_9px_9px\] {
            box-shadow: 9px 9px #6adaff
        }

        .\[box-shadow\:rgb\(19\2c _83\2c _254\)_2px_2px\] {
            box-shadow: 2px 2px #1353fe
        }

        .\[box-shadow\:rgb\(19\2c _83\2c _254\)_6px_6px\] {
            box-shadow: 6px 6px #1353fe
        }

        .\[box-shadow\:rgb\(255\2c _255\2c _255\)_6px_6px\] {
        ...
        .hover\:text-\[\#d6a701\]:hover {
            --tw-text-opacity: 1;
            color: #d6a701;
            color: rgba(214, 167, 1, var(--tw-text-opacity))
        }
        ...
        .hover\:\[box-shadow\:rgb\(0\2c _0\2c _0\)_7px_7px\]:hover {
        ...
        .focus\:border-\[\#3898ec\]:focus {
            --tw-border-opacity: 1;
            border-color: #3898ec;
            border-color: rgba(56, 152, 236, var(--tw-border-opacity))
        }
        ...
        @media (min-width:1024px) {
            ...
            .lg\:border-r-\[\#c3c0c04d\] {
                border-right-color: hsla(0, 2%, 76%, .302)
            }
            ...
            .lg\:shadow-\[0_16px_64px_-15px_rgba\(45\2c 96\2c 173\2c 0\.15\)\] {
                --tw-shadow: 0 16px 64px -15px rgba(45, 96, 173, .15);
                --tw-shadow-colored: 0 16px 64px -15px var(--tw-shadow-color);
                box-shadow: 0 0 transparent, 0 0 transparent, 0 16px 64px -15px rgba(45, 96, 173, .15);
        ...
        *,
        ...
        @font-face {
            ...
            font-style: #000;
            font-weight: 900;
            src: url(https://firebasestorage.googleapis.com/v0/b/tailwindfolio.appspot.com/o/fonts%2FSatoshi-Black.otf?alt=media&token=4c4d2d80-8421-4060-a9ca-a31cce5a1626) format("otf")
        }
    ...
    <link rel="preload" href="/_nuxt/static/1703852090/Landing%20Home3/state.js" as="script">
    <link rel="preload" href="/_nuxt/static/1703852090/Landing%20Home3/payload.js" as="script">
    <link rel="preload" href="/_nuxt/static/1703852090/manifest.js" as="script">
</head>
...
<body>
    <div data-server-rendered="true" id="__nuxt"><!---->
        <div id="__layout">
            <div class="relative">
                <nav x-data="{ isOpen: false, menuOne: false }"
                    ...
                    <div
                        ...
                        <div x-bind:class="isOpen ? 'show' : 'hidden'"
                            ...
                            <div class="relative flex flex-col"><a x-on:click.prevent="menuOne = !menuOne"
                                    href="#" x-bind:class="menuOne"
                                    class="flex flex-row text-[#000000] font-inter font-medium rounded-lg lg:px-6 lg:py-4 lg:hover:bg-gray-50 lg:hover:text-gray-800">Home
                                    <svg x-bind:class="menuOne ? 'rotate-180' : 'rotate-0'" viewBox="0 0 24 24"
                                        class="fill-current transition" style="width:24px;height:24px">
                                        <path d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"></path>
                                    </svg></a>
                                <div x-show="menuOne" x-on:click.outside="menuOne = false"
                                    ...
                                    <a href="https://tailwind-css-template-jetpack.vercel.app/Landing%20Home"
                                        class="flex grow flex-col rounded-lg px-5 py-4 lg:basis-[248px] xl:px-8">
                                        <h2 class="text-black font-inter text-lg font-medium">
                                            Landing Home
                                        </h2>
                                    </a> <a href="https://tailwind-css-template-jetpack.vercel.app/Landing%20Home2"
                                        class="flex grow flex-col rounded-lg px-5 py-4 lg:basis-[248px] xl:px-8">
                                        <h2 class="text-black font-inter text-lg font-medium">
                                            Landing Home 2
                                        </h2>
                                    </a> <a href="https://tailwind-css-template-jetpack.vercel.app/Landing%20Home3"
                                        class="flex grow flex-col rounded-lg px-5 py-4 lg:basis-[248px] xl:px-8">
                                        <h2 class="text-black font-inter text-lg font-medium">
                                            Landing Home 3
                                        </h2>
                                    </a> <a href="https://tailwind-css-template-jetpack.vercel.app/Landing%20Home4"
                                        class="flex grow flex-col rounded-lg px-5 py-4 lg:basis-[248px] xl:px-8">
                                        <h2 class="text-black font-inter text-lg font-medium">
                                            Landing Home 4
                                        </h2>
                                    </a></div>
                            </div> <a href="https://tailwind-css-template-jetpack.vercel.app/Landing%20About"
                                class="font-inter font-medium rounded-lg lg:px-6 lg:py-4 lg:hover:bg-gray-50 lg:hover:text-gray-800">About</a>
                        ...
                        <div x-bind:class="isOpen ? 'show' : 'hidden'"
                            class="flex flex-col space-y-8 lg:flex lg:flex-row lg:space-x-3 lg:space-y-0"><a
                                href="#"
                                ...
                                Started</a></div> <a href="#" x-on:click.prevent="isOpen = !isOpen"
                            class="absolute right-5 lg:hidden"><svg width="24" height="24"
                ...
                <section class="overflow-hidden">
                    <div data-aos="fade-up" data-aos-duration="900"
                        ...
                        <div class="grid grid-cols-1 items-center gap-12 sm:gap-20 lg:grid-cols-2 lg:gap-28">
                            <div class="max-w-[720px] lg:max-w-[842px]">
                                <h1 class="mb-4 text-4xl font-semibold md:text-6xl">
                                    ...
                                    <span
                                        class="bg-cover bg-center px-4 text-white bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6390526ac2a607693620c97b_Rectangle%2010.svg')]">Dev
                                        Time</span>
                                </h1>
                            ...
                            <div
                                class="relative mx-auto h-full max-h-[640px] w-[90%] max-w-[640px] lg:w-full lg:max-w-[480px]">
                                <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63915d1cb654acd795a72b12_magicpattern-ixxjruC7Gg4-unsplash.jpg"
                                    alt class="h-full w-full max-w-[800px] object-cover">
                                <div
                                    class="absolute -left-[7.5%] bottom-[10%] right-auto top-auto flex h-28 w-80 flex-col items-start justify-center border border-solid border-black bg-white px-5 py-3 [box-shadow:rgb(0,_0,_0)_4px_4px] lg:left-[-45%]">
                                    <div class="mb-4 flex h-auto items-start"><img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63906655aa174e025702f043_Group%20(1).svg"
                                            alt class="mr-2 inline-block">
                                        <p class="pt-1.5 text-sm text-[#636262]">
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit ut
                                            aliquam
                                        </p>
                                    </div>
                                    <div class="flex h-auto w-full items-center justify-between">
                                        <div class="flex items-center"><img
                                                ...
                                                alt class="mr-2 inline-block h-8">
                                            <div>
                                        ...
                                        <div><img
                                                ...
                                                alt class="mr-1 inline-block w-3.5"> <img
                                                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6390676b385b0525c99b09a8_Vector.svg"
                                                alt class="mr-1 inline-block w-3.5"> <img
                                                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6390676b385b0525c99b09a8_Vector.svg"
                                                alt class="mr-1 inline-block w-3.5"> <img
                                                ...
                                                alt class="mr-1 inline-block w-3.5"> <img
                                                src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6390676b385b0525c99b09a8_Vector.svg"
                                                alt class="mr-1 inline-block w-3.5"></div>
                                    </div>
                                </div>
                                <div
                                    class="absolute -left-[7.5%] -right-[5%] bottom-1/2 top-auto flex h-28 w-80 flex-col items-start justify-center border border-solid border-black bg-white px-5 py-3 [box-shadow:rgb(0,_0,_0)_4px_4px] sm:bottom-[35%] lg:left-auto lg:right-[-10%]">
                                    <div class="mb-4 flex h-auto items-start"><img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63906655aa174e025702f043_Group%20(1).svg"
                                            alt class="mr-2 inline-block">
                                        <p class="pt-1.5 text-sm text-[#636262]">
                                ...
                                <div
                                    class="absolute bottom-0 left-4 right-0 top-4 -z-10 h-full w-full -rotate-[4.5deg] bg-[#1353fe]">
                                </div>
                                <div
                                    class="absolute bottom-0 left-4 right-0 top-4 -z-10 h-full w-full -rotate-[10deg] bg-[#1353fe33]">
                                </div>
                            </div>
                        </div>
                    </div> <img
                        ...
                        alt
                        class="absolute bottom-0 left-auto right-0 top-auto -z-10 hidden md:bottom-auto md:left-auto md:right-0 md:top-0 md:inline-block">
                </section>
                <section>
                    <div data-aos="fade-up" data-aos-duration="900"
                        class="mx-auto w-full max-w-7xl px-5 pb-16 md:px-10 md:pb-24 lg:pb-32">
                        <h5 class="mb-6 text-center text-xl font-semibold md:mb-10 lg:mb-12"><span
                                class="text-blue-800">The world’s Innovative Companies</span>
                            Use Flowspark
                        </h5>
                        <div
                            class="grid grid-cols-1 gap-8 rounded-3xl bg-black p-16 sm:grid-cols-2 md:grid-cols-3 md:gap-16">
                            <div class="flex items-center justify-center"><img
                                    ...
                                    alt class="mx-auto inline-block max-w-[80%] max-[767px]:max-w-full"></div>
                            <div class="flex items-center justify-center"><img
                    ...
                    <div data-aos="fade-up" data-aos-duration="900"
                        ...
                        <div class="mx-auto w-full max-w-3xl text-center">
                            ...
                            <h2 class="text-3xl font-semibold md:text-5xl">
                                How it
                                <span
                                    class="bg-cover bg-center px-4 text-white bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/639156ce1c70c97aeb755c8a_Rectangle%2010%20(1).svg')]">works</span>
                            </h2>
                        ...
                        <div class="flex flex-col items-start gap-8 md:flex-row-reverse lg:gap-12">
                            <div class="flex max-w-[496px] flex-1 flex-col items-start"><a
                                    class="relative mb-8 flex gap-4 p-6">
                                    <div
                                        class="flex h-10 w-10 flex-none flex-col items-center justify-center rounded-full bg-[#1353FE]">
                                        <p class="font-bold text-white">1</p>
                                    </div>
                                    <div class="ml-4 flex flex-col gap-2">
                                        <h5 class="font-bold md:text-xl">STEP 1</h5>
                                        <p class="text-[#636262]">
                                            Lorem ipsum dolor sit amet consectetur adipiscing elit ut
                                            aliquam, purus sit.
                                        </p>
                                    </div>
                                </a> <a class="relative mb-8 flex gap-4 p-6">
                                    <div
                                        class="flex h-10 w-10 flex-none flex-col items-center justify-center rounded-full bg-[#1353FE]">
                                        <p class="font-bold text-white">2</p>
                                    </div>
                                    <div class="ml-4 flex flex-col gap-2">
                                        <h5 class="font-bold md:text-xl">STEP 2</h5>
                                        <p class="text-[#636262]">
                                            Lorem ipsum dolor sit amet consectetur adipiscing elit ut
                                            aliquam, purus sit.
                                        </p>
                                    </div>
                                </a> <a class="relative mb-8 flex flex-row gap-4 p-6">
                                    <div
                                        class="flex h-10 w-10 flex-none flex-col items-center justify-center rounded-full bg-[#1353FE]">
                                        <p class="font-bold text-white">3</p>
                                    </div>
                                    <div class="ml-4 flex flex-col gap-2">
                                        <h5 class="font-bold md:text-xl">STEP 3</h5>
                                        <p class="text-[#636262]">
                                            Lorem ipsum dolor sit amet consectetur adipiscing elit ut
                                            aliquam, purus sit.
                                        </p>
                                    ...
                                    <div
                                        class="flex h-10 w-10 flex-none flex-col items-center justify-center rounded-full bg-[#1353FE]">
                                        <p class="font-bold text-white">4</p>
                                    </div>
                                    <div class="ml-4 flex flex-col gap-2">
                                        <h5 class="font-bold md:text-xl">STEP 4</h5>
                                        <p class="text-[#636262]">
                                            Lorem ipsum dolor sit amet consectetur adipiscing elit ut
                                            aliquam, purus sit.
                                        </p>
                            ...
                            <div class="overflow-hidden relative left-4 max-h-[500px] max-w-[500px] md:left-0"><img
                                    ...
                                    alt
                                    class="mx-auto block h-full w-full max-w-[800px] rotate-[3.5deg] rounded-2xl object-cover">
                                <div
                                    class="absolute bottom-0 left-[-16px] right-0 top-4 -z-10 h-full w-full rounded-2xl bg-black">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div data-aos="fade-up" data-aos-duration="900"
                        class="mx-auto w-full max-w-5xl px-5 pb-16 md:px-10 md:pb-24 lg:pb-32">
                        ...
                        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-20">
                            <div class="flex flex-col items-start"><a
                                    class="my-4 flex max-w-[480px] items-center rounded-xl border border-solid border-[#4273f6] bg-[#4273f6] p-6 font-bold text-white [box-shadow:rgb(0,_0,_0)_-4px_4px]">
                                    <div
                                    ...
                                    class="my-4 flex max-w-[480px] items-center rounded-xl border border-solid border-black p-6 font-bold [box-shadow:rgb(0,_0,_0)_-4px_4px]">
                                    <div
                                        class="relative mr-2 flex h-14 w-14 flex-none flex-col items-center justify-center rounded-md border border-[#9b9b9b] bg-white [box-shadow:rgb(0,_0,_0)_2px_2px]">
                                        <img alt
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6391586264bf263c3a734e6d_Group%2047875.png"
                    ...
                    <div data-aos="fade-up" data-aos-duration="900"
                        ...
                        <div class="text-center">
                            <h2 class="text-3xl font-semibold md:text-5xl">
                                Our Team
                                <span
                                    class="bg-cover bg-center px-4 text-white bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/639156ce1c70c97aeb755c8a_Rectangle%2010%20(1).svg')]">Members</span>
                            </h2>
                            <p class="mx-auto mb-8 mt-4 max-w-[528px] text-[#636262] md:mb-12 lg:mb-16">
                        ...
                        <div
                            ...
                            <div
                                class="flex flex-col items-center justify-center gap-4 rounded-xl border border-solid border-[#636262] p-4 [box-shadow:rgb(0,_0,_0)_6px_6px]">
                                <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63980b423c019a5273ee5c6e_Rectangle%2040024.jpg"
                                    alt class="mb-4 inline-block h-56 w-full rounded-xl object-cover lg:h-56">
                                <p class="mb-2 font-bold">John Brooklyn</p>
                                <p class="mb-2 text-sm text-[#636262]">Developer</p>
                                <div class="mt-4 flex flex-wrap"><a href="#"
                                        class="mr-4 flex h-8 w-8 max-w-full flex-col items-center justify-center rounded-sm bg-[#ecf2ff] px-2 font-bold text-[#1353fe]"><img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63980be38447c887bfd955b8_InstagramLogo.svg"
                                            alt class="inline-block h-full w-full"></a> <a href="#"
                                        class="mr-4 flex h-8 w-8 max-w-full flex-col items-center justify-center rounded-sm bg-[#ecf2ff] px-2 font-bold text-[#1353fe]"><img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63980be307547130d2e965fd_SlackLogo.svg"
                                            alt class="inline-block h-full w-full"></a> <a href="#"
                                        class="flex h-8 w-8 max-w-full flex-col items-center justify-center rounded-sm bg-[#ecf2ff] px-2 font-bold text-[#1353fe]"><img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63980be16658297f6be979d2_TwitterLogo.svg"
                                            alt class="inline-block h-full w-full"></a></div>
                            </div>
                            <div
                                class="flex flex-col items-center justify-center gap-4 rounded-xl border border-solid border-[#636262] p-4 [box-shadow:rgb(0,_0,_0)_6px_6px]">
                                <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63980b3c3c019a6473ee5b4e_Rectangle%2040024-1.jpg"
                                    alt class="mb-4 inline-block h-56 w-full rounded-xl object-cover lg:h-56">
                                <p class="mb-2 font-bold">John Brooklyn</p>
                                <p class="mb-2 text-sm text-[#636262]">Developer</p>
                                <div class="mt-4 flex flex-wrap"><a href="#"
                            ...
                            <div
                                class="flex flex-col items-center justify-center gap-4 rounded-xl border border-solid border-[#636262] p-4 [box-shadow:rgb(0,_0,_0)_6px_6px]">
                                <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63980b390754711c1de95455_Rectangle%2040024-2.jpg"
                                    alt class="mb-4 inline-block h-56 w-full rounded-xl object-cover lg:h-56">
                                <p class="mb-2 font-bold">John Brooklyn</p>
                                <p class="mb-2 text-sm text-[#636262]">Developer</p>
                                <div class="mt-4 flex flex-wrap"><a href="#"
                ...
                <section>
                    <div class="mx-auto w-full max-w-7xl px-5 pb-16 md:px-10 md:pb-24 lg:pb-32">
                        <div class="text-center grid items-center gap-8 sm:gap-20 lg:grid-cols-2 lg:text-left">
                            <div class="flex max-w-2xl flex-col items-start">
                                ...
                                <div
                                    class="mb-8 grid grid-cols-1 gap-6 rounded-2xl border border-solid border-black bg-white p-6 [box-shadow:rgb(0,_0,_0)_9px_9px] lg:mb-4">
                                    <div class="flex"><img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63904f663019b0ce62f8d5ba_Vector.svg"
                                            alt class="mr-1 inline-block w-3.5 flex-none"> <img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63904f663019b0ce62f8d5ba_Vector.svg"
                                            alt class="mr-1 inline-block w-3.5 flex-none"> <img
                                            src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63904f663019b0ce62f8d5ba_Vector.svg"
                                            alt class="mr-1 inline-block w-3.5 flex-none"> <img
                            ...
                            <div class="mx-auto max-w-xl bg-[#f2f2f7] p-8 text-center rounded-3xl border">
                                ...
                                <form name="wf-form-password" class="mb-4 w-full text-left">
                                    <div class="mb-4 flex flex-col gap-y-2"><label for="name-2"
                                            class="mb-1 font-bold">Your Name</label> <input
                                            placeholder="Enter Your Name" required
                                            class="h-9 w-full bg-[#FAFAFA] px-3 py-6 text-sm text-[#D8D8D8]"></div>
                                    <div class="mb-4 flex flex-col gap-y-2"><label for="name-2"
                                            class="mb-1 font-bold">Email</label> <input placeholder="Enter Your Email"
                                            required class="h-9 w-full bg-[#FAFAFA] px-3 py-6 text-sm text-[#D8D8D8]">
                                    </div>
                                    <div class="mb-8 flex flex-col gap-y-2"><label for="field-3"
                                            class="mb- font-bold">Project Brief</label>
                                        <textarea placeholder="Enter Your Brief"
                                            class="h-auto min-h-[186px] w-full overflow-auto bg-[#FAFAFA] px-3 py-6 text-sm text-[#D8D8D8]"></textarea>
                                    </div> <input type="submit" value="Get Started"
                ...
                <header class="text-white">
                    <div data-aos="fade-up" data-aos-duration="900" class="px-5 pb-16 md:px-10 md:pb-24 lg:pb-32">
                        <div
                            ...
                            <div class="mx-auto mb-6 max-w-[720px] md:mb-12">
                                <h2 class="mb-4 text-3xl font-semibold md:text-5xl"><span
                                        class="bg-cover bg-center px-4 text-white bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6391a5b04f2836ad87dcc3bc_Rectangle%20773.svg')]">Lightning
                            ...
                            <form name="email-form" method
                                class="relative mx-auto flex w-full max-w-[80%] flex-col md:max-w-[560px]"><input
                                    type="email" name="email" placeholder="Enter your email"
                                    class="h-9 w-full rounded-xl bg-white px-3 py-8 text-sm text-[#333333] focus:border-[#3898ec] focus:outline-0">
                                <input type="submit" value="Subscribe"
                                    class="absolute bottom-auto left-auto right-2 top-1 inline-block cursor-pointer rounded-xl bg-black px-8 py-4 font-semibold text-white [box-shadow:rgb(19,_83,_254)_2px_2px]">
                            </form>
                        </div>
                    </div>
                </header>
                <section class="overflow-hidden">
                    <div class="w-screen flex-col bg-black px-6 py-20 lg:flex lg:px-10 xl:px-24">
                        <div class="lg:flex lg:flex-row lg:justify-between">
                            <div><a href="#" class="mb-8 inline-block max-w-full"><img
                                        src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6399728d302d2471f18b229f_Group%2047874%20(2).svg"
                                        alt class="inline-block max-h-10"></a>
                                <p class="font-inter mt-4 max-w-[350px] text-base font-light text-gray-500">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit ut al
                                </p>
                                <div class="mb-8 mt-6 flex flex-row"><a href
                                        class="mr-4 text-black transition hover:text-gray-400"><svg width="24"
                                        ...
                                        </svg></a> <a href class="mx-4 text-black transition hover:text-gray-400"><svg
                            ...
                            <div class="flex grow flex-row flex-wrap lg:mx-10 lg:flex-nowrap lg:justify-center">
                                <div
                                    class="my-5 mr-8 flex max-w-[200px] grow basis-[100px] flex-col space-y-5 lg:mx-10 lg:mt-0">
                                    <h2 class="font-inter font-medium text-white">SOLUTION</h2> <a href
                                        class="font-inter font-light text-gray-500">Marketing</a> <a href
                                        class="font-inter font-light text-gray-500">Analytics</a>
                                </div>
                                <div
                                    class="my-5 mr-8 flex max-w-[200px] grow basis-[100px] flex-col space-y-5 lg:mx-10 lg:mt-0">
                                    <h2 class="font-inter font-medium text-white">SUPPORT</h2> <a href
                                        class="font-inter font-light text-gray-500">Pricing</a> <a href
                                        class="font-inter font-light text-gray-500">Documentation</a>
                                </div>
                            </div>
                            <div class="mt-10 flex flex-col lg:mt-0">
                                <div class="mb-4 flex flex-row items-center"><svg width="36" height="36"
                                    ...
                                    <p class="font-inter ml-4 text-gray-500">
                                ...
                                <div class="mb-4 flex flex-row items-center"><svg width="36" height="36"
                                    ...
                                    <p class="font-inter ml-4 text-gray-500">support@devjoy.xyz</p>
                                </div>
                            </div>
                        </div>
                        <div class="mx-auto my-12 w-full border border-[#E4E4E7] lg:my-20"></div>
                        <div>
                            <p class="font-inter text-center text-sm text-gray-500 lg:mt-0">
    ...
    <script defer src="/_nuxt/static/1703852090/Landing%20Home3/state.js"></script>
    <script src="/_nuxt/935c6dc.js" defer></script>
    <script src="/_nuxt/459230f.js" defer></script>
    <script src="/_nuxt/f1383dd.js" defer></script>
    <script src="/_nuxt/4827497.js" defer></script>
    <script src="/_nuxt/546c9d8.js" defer></script>
    <script src="/_nuxt/f824e29.js" defer></script>
</body>

    ...
    <div class="flex w-screen flex-col px-6 py-20 lg:px-10 xl:px-24">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between">
            ...
            <div class="flex flex-col lg:mr-20">
                ...
                <a href="#" class="mb-12 inline-block max-w-full font-bold text-[#1353fe]">
                    <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/6399728d302d2471f18b229f_Group%2047874%20(2).svg"
                ...
                <div class="flex flex-col">
                    <form action="" class="mb-10 mt-5 max-w-[421px]">
                        <div class="relative">
                            <label for="email" class="font-inter font-medium">SUBSCRIBE TO
                                NEWSLETTER</label>
                            <input type="email"
                                class="font-inter relative mt-4 w-full rounded-md border border-black bg-[#232323] px-6 py-4 text-base"
                                placeholder="Enter your email" name="email" />
                            <button type="submit" class="absolute right-[15px] top-[55px]">
                                <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/639974a7f44de6baa9a134aa_PaperPlaneTilt%20(1).svg"
        ...
        <div class="mt-20 lg:flex lg:flex-row-reverse lg:justify-between">
            ...
            <div class="mb-8 mt-6 flex flex-row lg:mb-0 lg:mt-0">
                ...
                <a href="" class="mx-4 transition hover:text-gray-400">
                    <svg class="fill-current" width="25" height="25" viewBox="0 0 25 25"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
